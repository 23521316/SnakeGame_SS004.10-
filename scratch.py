...
font = pygame.font.Font('../../../AppData/Roaming/JetBrains/PyCharmCE2023.3/scratches/Roboto-Medium (1).ttf', 25)
...
class SnakeGame:
    ...
    def __init__(self, w=1000, h=800):
        ...
        pygame.display.set_caption('23521682-23521316-23520610.game')
